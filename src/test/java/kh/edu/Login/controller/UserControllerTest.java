...
@ContextCofiguration(classes = LoginApplication.class)
public class UserControllerTest {
    ...
    // 로그인 성공 테스트
    // DB에 실질저그올 접근하지 못할 때 사용하는 테스트 기법
    // Controller 에 작성한 메서드 명칭과 테스트 메서드 기능명칭이 동일하지 않아도 됨
    @Test
    public void loginSuccessTest() throws Exception {
        UserVO dummyUser = new UserVO(); // DB에 연결되어 있지 않기 때문에 연결이 된다는 가정하에 아이디 비밀번호 설정
        ...
        mvc.perform(
                ...
                // html 파일에서 파일 명칭이 "loginSuccess" 인 파일로 이동하기
